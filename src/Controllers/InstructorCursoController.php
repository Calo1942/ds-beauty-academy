...
use DsBeautyAcademy\Models\InstructorCursoModel;

$module_config = [
    'primary_key' => 'id_instructor_curso',
    'fields' => ['id_instructor', 'id_curso'],
    'view_path' => 'instructor_curso.php'
];

$model = new InstructorCursoModel();
$action = null;
