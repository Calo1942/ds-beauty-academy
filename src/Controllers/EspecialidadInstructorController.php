...
use DsBeautyAcademy\Models\EspecialidadInstructorModel;

$module_config = [
    'primary_key' => 'id_instructor',
    'fields' => ['id_instructor', 'id_especialidad'], // id_especialidad debe enviarse como array desde el front
    'view_path' => 'especialidad_instructor.php'
];

$model = new EspecialidadInstructorModel();
$action = null;
