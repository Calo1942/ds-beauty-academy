...
use DsBeautyAcademy\Models\EntregaEvaluacionModel;

$module_config = [
    'primary_key' => 'id_entrega_evaluacion',
    'fields' => [
        'id_evaluacion',
        'id_matricula',
        'url_archivo_entrega',
        ...
        'retroalimentacion_instructor',
        'estatus_entrega'
    ],
    'view_path' => 'entrega_evaluaciones.php'
];

$model = new EntregaEvaluacionModel();
$action = null;
