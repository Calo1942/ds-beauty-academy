...
use DsBeautyAcademy\Models\RecursoCursoModel;

$module_config = [
    'primary_key' => 'id_curso',
    'fields' => ['id_curso', 'id_recurso'], // id_recurso will be an array
    'view_path' => 'recursos_curso.php'
];

$model = new RecursoCursoModel();
$action = null;
