<div id="modalDetalle" class="modal">
    <div class="modal-content" style="max-width: 600px;">
        <div class="modal-header">
            <h2 class="modal-title">Detalle del Instructor</h2>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div class="detail-avatar-container">
                    ...
                    <div class="detail-info-header">
                        <div class="detail-id-badge">ID: <span id="detail_id_instructor_badge"></span></div>
                ...
                <div class="detail-item" style="grid-column: span 2; display: none;">
                    ...
                    <span id="detail_id_instructor" class="detail-value"></span>
                </div>
