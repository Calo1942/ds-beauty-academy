...
class EspecialidadModel extends DBConnect implements Crud
{
    ...
    private $idField = 'id_especialidad';
    private $statusField = 'estatus_especialidad';
